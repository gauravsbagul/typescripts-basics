...
System.register("file:///F:/deno/deno-hello-world/02-features/07-single-executable/index", ["https://deno.land/std/fmt/colors"], function (exports_2, context_2) {
    "use strict";
    var colors_ts_1;
    ...
    return {
        ...
        execute: function () {
            console.log(`This is ${colors_ts_1.green("green")} text`);
            console.log(`This is ${colors_ts_1.underline("underline")} text`);
        }
    };
});

__instantiate("file:///F:/deno/deno-hello-world/02-features/07-single-executable/index", false);
